/**
 * SimpleNavyBadge SVG - Dark blue elegant card
 */
...
export const SimpleNavyBadge: React.FC<SVGBadgeProps> = ({
  photoDataUri,
  displayName,
  stats,
  t,
  ...
  return (
    <Svg width={width} height={height} viewBox="0 0 300 300">
      ...
      {photoDataUri ? (
        ...
        <G>
          <Circle cx="150" cy="56" r="29" fill="rgba(255, 255, 255, 0.15)" />
          <Text x="150" y="64" textAnchor="middle" fill="#fbbf24" fontSize="24" fontWeight="700" fontFamily={FONT_FAMILY}>
            {initial}
          </Text>
        </G>
      )}
      ...
      {stats && (
        <G>
          <Text x="150" y="185" textAnchor="middle" fill="#f8fafc" fontSize="64" fontWeight="800" fontFamily={FONT_FAMILY}>
            {stats.completedCeremonies}
          </Text>
          <Text x="150" y="210" textAnchor="middle" fill="rgba(248, 250, 252, 0.6)" fontSize="12" fontWeight="500" fontFamily={FONT_FAMILY}>
            {t("ceremonies")}
          </Text>
        </G>
      )}
