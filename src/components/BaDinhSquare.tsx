  ...
  return (
    <View style={{ opacity }}>
      <Svg width={width} height={height} viewBox="0 0 400 300">
        ...
        {/* Ground / Square */}
        <Rect x="0" y="180" width="400" height="120" fill={fgColor} opacity={0.3} />
        ...
        <Path
          d="M 80,180 L 320,180 L 305,155 L 95,155 Z"
          fill={fgColor}
        />
        ...
        {/* Mausoleum Roof */}
        <Path
          d="M 110,75 L 290,75 L 283,63 L 117,63 Z"
          fill={accentColor}
        />
        <Path
          d="M 117,63 L 283,63 L 278,55 L 122,55 Z"
          fill={fgColor}
        />
        
        {/* Top roof section */}
        <Rect x="140" y="45" width="120" height="10" fill={accentColor} opacity={0.9} />
        <Path
          d="M 145,45 L 255,45 L 250,38 L 150,38 Z"
          fill={fgColor}
        />

        {/* Text area - "CHỦ TỊCH" */}
        <Rect x="155" y="57" width="90" height="6" fill={bgColor} opacity={0.5} />
        
        {/* Text area - "HỒ CHÍ MINH" */}
        <Rect x="130" y="65" width="140" height="8" fill={bgColor} opacity={0.5} />

        {/* Entrance */}
        <Rect x="185" y="110" width="30" height="28" fill={flagRed} opacity={0.4} />
        ...
        <G>
          ...
          <Ellipse cx="15" cy="178" rx="20" ry="18" fill={bgColor} opacity={0.5} />
          <Ellipse cx="45" cy="175" rx="25" ry="20" fill={fgColor} />
          
          <Ellipse cx="70" cy="165" rx="28" ry="22" fill={fgColor} />
          <Ellipse cx="60" cy="173" rx="18" ry="15" fill={bgColor} opacity={0.5} />
        </G>
        
        {/* Trees/Bushes - Right side */}
        <G>
          <Ellipse cx="375" cy="170" rx="30" ry="25" fill={fgColor} />
          <Ellipse cx="385" cy="178" rx="20" ry="18" fill={bgColor} opacity={0.5} />
        ...
        <G>
          ...
          {[140, 175, 210, 245].map((x, i) => (
            <G key={`bonsai${i}`}>
              <Rect x={x - 5} y="182" width="10" height="8" fill={accentColor} opacity={0.7} />
