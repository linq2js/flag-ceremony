...
export const HandRaisedIcon: React.FC<IconProps> = ({ size = 24, color = "#fff" }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
...
// Five fingers icon
export const FingersIcon: React.FC<IconProps> = ({ size = 24, color = "#fff" }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
...
export const RulerIcon: React.FC<IconProps> = ({ size = 24, color = "#fff" }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
      d="M3 5L21 5"
      stroke={color}
...
export const AngleIcon: React.FC<IconProps> = ({ size = 24, color = "#fff" }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
      d="M4 20H20"
      stroke={color}
...
// Music note icon
export const MusicIcon: React.FC<IconProps> = ({ size = 24, color = "#fff" }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
      d="M9 18V5L21 3V16"
      stroke={color}
...
export const HandshakeIcon: React.FC<IconProps> = ({ size = 24, color = "#fff" }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
...
export const StrengthIcon: React.FC<IconProps> = ({ size = 24, color = "#fff" }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
...
export const StatsIcon: React.FC<IconProps> = ({ size = 24, color = "#fff" }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Rect x={4} y={13} width={4} height={8} rx={1} stroke={color} strokeWidth={2} />
    <Rect x={10} y={9} width={4} height={12} rx={1} stroke={color} strokeWidth={2} />
    <Rect x={16} y={4} width={4} height={17} rx={1} stroke={color} strokeWidth={2} />
  </Svg>
);
...
// Fire/streak icon
export const FireIcon: React.FC<IconProps> = ({ size = 24, color = "#fbbf24" }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
...
// Arrow right icon
export const ArrowRightIcon: React.FC<IconProps> = ({ size = 24, color = "#fff" }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
